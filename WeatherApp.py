...
# create a function to stop the text speaker
# def Stop_Text_Speaker():
#     speaker_engine = pyttsx3.init() #................ initiate the talkback engine
#     speaker_engine.say('stop') #............... Speak the command
#     speaker_engine.runAndWait() #.................... Run the engine

   
# stop_instructions = 'stop'
...
def transcribe_speech():
    ...
    with sr.Microphone() as source:
        ...
        with st.spinner(text='Silence please, Caliberating background noise.....'):
            time.sleep(3)
...
st.subheader("Hi, I'm Tom, I Can Help You Predict The Weather")
